...
function RouteComponent() {
  ...
  return (
    <div className="relative flex-col min-h-screen bg-gradient-to-br from-background via-background to-muted/10 flex items-center justify-center p-4">
      <Button className="absolute top-8 left-8" asChild>
        <Link to="/">กลับ</Link>
      </Button>
      <Card className="w-full max-w-xl shadow-xl border-0 bg-card/80 backdrop-blur">
        ...
        <CardFooter className="flex">
          <Button disabled={!canDownload} className="flex-1">
            <Download />
            ดาวน์โหลด
          </Button>
        </CardFooter>
