      ...
      <div className="grid grid-cols-1 lg:grid-cols-[350px_1fr] gap-6">
        ...
        <div className="space-y-6">
          <Tabs defaultValue="content" className="w-full">
            <TabsList className="border border-primary/50">
              <TabsTrigger
                value="content"
                className="flex items-center gap-2 data-[state=active]:bg-primary/80 data-[state=active]:text-primary-foreground"
              >
                <Activity />
                กิจกรรมและข้อมูล
              </TabsTrigger>
...
// Route component
export const Route = createFileRoute("/admin/home/members/$memberId")({
